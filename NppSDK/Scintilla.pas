...
type
   uptr_t  = LongWord;
   sptr_t  = LongWord;
   TSciFnDirect = function(ptr: sptr_t; iMessage: Cardinal; wParam: uptr_t; lParam: sptr_t): sptr_t;cdecl;
{$ENDIF}
 ...
 * So older code that treats Scintilla as a RichEdit will work. *)
 ...
 TTextToFind = TSci_TextToFind;

(* This structure is used in printing and requires some of the graphics types
 * from Platform.h.  Not needed by most client code.

  TSci_RangeToFormat = packed record
    hdc       : SurfaceID;
    hdcTarget : SurfaceID;
    rc        : PRectangle;
    rcPage    : PRectangle;
  ...
  TRangeToFormat = TSci_RangeToFormat;
 *)
  ...
  TSci_NotifyHeader = record
	  ...
	  * but most clients of Scintilla.h do not have this type visible. *)
	  hwndFrom : Cardinal;//hwndFrom : Pointer;  // void *hwndFrom
	  idFrom   : uptr_t;
	  code     : Cardinal;
  end;
  TNotifyHeader = TSci_NotifyHeader;
  
  PSCNotification = ^TSCNotification;
  TSCNotification = record
	  _nmhdr                : TSci_NotifyHeader;
    _position             : Integer;	(* SCN_STYLENEEDED, SCN_MODIFIED, SCN_DWELLSTART, SCN_DWELLEND *)
    _ch                   : Integer;  (* SCN_CHARADDED, SCN_KEY *)
    _modifiers            : Integer;	(* SCN_KEY *)
    _modificationType     : Integer;	(* SCN_MODIFIED *)
    _text                 : {$IFDEF UNICODE}PWideChar{$ELSE}PAnsiChar{$ENDIF};(* SCN_MODIFIED, SCN_USERLISTSELECTION, SCN_AUTOCSELECTION *)
    _length               : Integer;	(* SCN_MODIFIED *)
    _linesAdded           : Integer;	(* SCN_MODIFIED *)
  {$IFDEF MACRO_RECORD_SUPPORT}	
    _message              : Integer;	(* SCN_MACRORECORD *)
    _wParam               : uptr_t;   (* SCN_MACRORECORD *)
    _lParam               : sptr_t;   (* SCN_MACRORECORD *)
  {$ENDIF}
    _line                 : Integer;	(* SCN_MODIFIED *)
    _foldLevelNow         : Integer ;	(* SCN_MODIFIED *)
    _foldLevelPrev        : Integer;	(* SCN_MODIFIED *)
    _margin               : Integer;	(* SCN_MARGINCLICK *)
    _listType             : Integer;	(* SCN_USERLISTSELECTION *)
    _x                    : Integer;	(* SCN_DWELLSTART, SCN_DWELLEND *)
    _y                    : Integer;	(* SCN_DWELLSTART, SCN_DWELLEND *)
    _token                : Integer;	(* SCN_MODIFIED with SC_MOD_CONTAINER *)
    _annotationLinesAdded : Integer;	(* SC_MOD_CHANGEANNOTATION *)
 end;

  PSearchResultMarking = ^TSearchResultMarking;
  TSearchResultMarking = record
	  _start : Integer;
   	_end   : Integer;
  end;

  TSearchResultMarkings = record
	  _length   : Integer;
   	_markings : PSearchResultMarking;
  end;
implementation
